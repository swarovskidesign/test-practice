...
def insert_sort():
    ...
    #сравнивается уже в сортированном списке и вставляет куда надо
...
def merg_sort():
    ...
    #разделяет на 2 половины и рекурсивно сравнивает
...
def quick_sort():
    ...
    #выбирает опорный элемент, потом разделяет на 2 группы и сравнивается
...
def count_sort():
    ...
    #подсчитывает количество элементов в массиве и распределяет элементы в нужном порядке
...
def menu():
    ...
    print("3. Сортировка слияние")
    print("4. Быстрая сортировка")
    print("5. Сортировка подсчетом")
